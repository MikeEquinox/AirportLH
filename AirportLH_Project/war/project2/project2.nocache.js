...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "project2" because\n';
  ...
  $wnd.__gwt_activeModules['project2'] = {
    'moduleName' : 'project2',
    'bindings' : function() {
      return {};
    }
 ...
 * "/project2.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['project2'].superdevmode = true;

  var expectedSuffix = '/project2.nocache.js';
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + project2 + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:project2';
  var devModeSessionKey = '__gwtDevModeSession:project2';

  // Compute some codeserver urls so as the user does not need bookmarklets
  var hostName = $wnd.location.hostname;
  var serverUrl = 'http://' + hostName + ':9876';
  var nocacheUrl = serverUrl + '/project2/project2.nocache.js';
  ...
  $wnd.__gwt_activeModules['project2'].canRedirect = true;
  $wnd.__gwt_activeModules['project2'].superdevmode = true;
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/project2?user.agent=' + ua + '&_callback=' + callback;
